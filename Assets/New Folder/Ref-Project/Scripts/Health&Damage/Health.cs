...
public class Health : MonoBehaviour
{
    ...
    private Respawn_enemy enemySpawnScrip;
    private Score playerGetScore;
    private Game_Controll stateGame;

    public Collider2D Rbox, Lbox;
    ...
    void Die()
    {
         ...
         {
            Debug.Log("Player Die and Destory");
             Instantiate(deathEffect, transform.position, transform.rotation, null);
             stateGame = FindObjectOfType<Game_Controll>();
             stateGame.PauseGame();
